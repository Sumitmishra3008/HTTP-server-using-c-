...
/*------------------------- Snippets -----------------------*/
// primeFactorization - get factors of a number using sieve and generate prime
// sieve - checks weather a number is prime or not
// segmentedTree_pointUpdate - range based queries
// segmentedTree_rangeUpdate - range based queries
// DSU - Disjoint set Union , gets number of components
// stringMatching_rabinKarp - get the string hash value and match 2 string (rabin karp)
